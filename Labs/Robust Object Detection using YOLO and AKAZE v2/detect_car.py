...
INPUT_FILE = "day_drive/VID-20220724-WA0004.mp4"
OUTPUT_FILE = "day_drive_out_test_0004.mp4"
...
class distanceDetector:
    ...
    def detect(self, img):
        ...
        if detect:
            stats_first_frame = self.tracker.setFirstFrame(img, rois, "AKAZE Features")
